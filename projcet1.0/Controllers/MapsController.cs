...
namespace projcet1._0.Controllers
{
    public class MapsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CountryName,RegionName,CityName,GeoLong,GeoLat")] Map map)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CountryName,RegionName,CityName,GeoLong,GeoLat")] Map map)
        {
            if (id != map.Id)
            {
                return NotFound();
